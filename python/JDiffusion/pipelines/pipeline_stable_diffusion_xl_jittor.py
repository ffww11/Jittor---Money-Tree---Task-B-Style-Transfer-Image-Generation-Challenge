...
from python.JDiffusion.pipelines.pipeline_output_jittor import StableDiffusionXLPipelineOutput
from python.JDiffusion.models import AutoencoderKL, UNet2DConditionModel
