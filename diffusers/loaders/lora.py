...
class LoraLoaderMixin:
    ...
    def load_lora_weights(
        self, pretrained_model_name_or_path_or_dict: Union[str, Dict[str, torch.Tensor]], adapter_name=None, lora_scale=1, **kwargs
    ):
        """
        ...
        b = 0
        c=0
        #pytorch train lora unet 256 text 184    jittor lora unet 192 text 184
        for i in state_dict:
            if i.__contains__('unet'):
                a+=1
            if i.__contains__('text_encoder'):
                b+=1
            if i.__contains__('to_out'):
                c+=1
            state_dict[i] = state_dict[i].float16()
