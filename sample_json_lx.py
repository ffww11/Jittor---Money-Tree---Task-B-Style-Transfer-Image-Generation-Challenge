...
def parse_args():
    ...
    parser.add_argument("--weight", type=str, default='best_model814v2')
...
def main(i, weight, t, seed_random=0):
    ...
    for id, data in prompts.items():
        ...
        # if prompt in ["Computer", "Grass", "Lavender", "Plate", "Watch"]:
        # if prompt in ["Workshop"]:
        if True:
